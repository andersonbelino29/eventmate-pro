...
const ReservationSuccess = () => {
  ...
  useEffect(() => {
    // Get reservation data from location state or sessionStorage
    const stateData = location.state;
    const sessionData = sessionStorage.getItem('reservationData');
    
    if (stateData) {
      setReservationData(stateData.reservationData);
      setPaymentRequired(stateData.paymentRequired || false);
    } else if (sessionData) {
      setReservationData(JSON.parse(sessionData));
    } else {
      ...
      <div className="container mx-auto px-4 py-8">
        ...
        <div className="text-center mb-8">
          ...
          <h1 className="text-3xl font-bold text-green-800 mb-2">
            {paymentRequired ? "Pagamento Confirmado!" : "Reserva Confirmada!"}
          </h1>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <div className="lg:col-span-2 space-y-6">
              ...
              <CardContent>
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  ...
                  <div className="space-y-4">
                    ...
                    <Badge className={paymentRequired ? "bg-green-100 text-green-800" : "bg-blue-100 text-blue-800"}>
                      <CheckCircle className="h-3 w-3 mr-1" />
                      {paymentRequired ? "Pago" : "Confirmado"}
                    </Badge>
                  </div>
                </div>
              </CardContent>
              ...
              <CardContent>
                ...
                {customerData.observations && (
                  <div className="mt-4">
                    ...
                    <p className="font-medium">{customerData.observations}</p>
                  </div>
                )}
              </CardContent>
            </Card>
            ...
            <Card>
              <CardHeader>
                <CardTitle>Informações {paymentRequired ? "de Pagamento" : "da Reserva"}</CardTitle>
              </CardHeader>
              <CardContent>
                <div className="space-y-3">
                  <div className="flex justify-between">
                    <span>Subtotal ({selectedTable.seats} pessoas):</span>
                  ...
                  <div className="text-sm text-muted-foreground">
                    {paymentRequired 
                      ...
                      : "Pagamento a combinar conforme acordado"
                    }
                  </div>
                </div>
              </CardContent>
